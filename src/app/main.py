...
ARTIFACT_DIR = os.path.join(os.path.dirname(_file_), "../../artifacts/")
...
from prometheus_client import Counter, Histogram, start_http_server, REGISTRY, generate_latest
...
EMPTY_RECOMMENDATIONS = Counter('empty_recommendations_total', 'Number of times no recommendations were found')
